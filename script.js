...
points.forEach(function(pt, index) {
    var numberedIcon = L.divIcon({
        ...
        html: '<div style="background: #2A81CB; color: white; border-radius: 12px; width: 24px; height: 24px; text-align: center; line-height: 24px;">' + (index + 1) + '</div>',
        iconSize: [24, 24],
        iconAnchor: [12, 24]
    });
...
document.getElementById('finishBtn').addEventListener('click', function() {
    // auto finish requires all points; this check is redundant now
